  ...
  <Layout>
    ...
    if (obj && obj.x && obj.x.y)
      ...
      <p>
        ...
        resolver esse problema. Ela se chama <Link href="https://claudepache.github.io/es-optional-chaining/">
          <a>Optional Chaining</a></Link>. Em resumo, a proposta diz
    ...
    return obj.x?.y // undefined`}</Snippet>
      ...
      <p>
        ...
        ver o código, <Link href="https://github.com/fernahh/try.js"><a>está no Github</a></Link>.
      </p>
    ...
    tryjs(obj, 'add', [1, 2]) // 3`}</Snippet>
      ...
      <p>
        ...
        amigo <Link href="https://twitter.com/rodrigowillrich"><a>@rodrigowillrich</a></Link>.
      ...
      <p>
        A <Link href="https://lodash.com/"><a>Lodash</a></Link> possui uma função
    ...
    _.get(obj, 'x.y', 1) // 1`}</Snippet>
      ...
      <p>
        O <Link href="http://ramdajs.com"><a>Ramda</a></Link> também possui uma
    ...
    R.prop('x', obj) // undefined`}</Snippet>
      ...
      <p>
        ...
        o objeto R representa o <Link href="http://ramdajs.com"><a>Ramda</a></Link>.
      </p>
